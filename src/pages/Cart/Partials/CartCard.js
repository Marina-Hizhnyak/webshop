    ...
    <div class="col p-2">
      <a class="card user-link d-flex flex-column h-100" href="/product?id=${product.id}">
        <div class="card-body px-2 py-2">
          ...
          <button class="btn btn-primary btn-lg mr-3 btn-delete-cart" data-id="${product.id}" onclick="event.preventDefault(); event.stopPropagation(); deleteProduct(${product.id});">Delete</button>
        </div>
      </a>
    </div>
    `;
